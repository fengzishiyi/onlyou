...
from PySide6.QtCore import Qt, QRect, QPoint, QTimer, QSize, QEvent, QMargins
...
class TitleButton(QPushButton):
    def __init__(self, icon_code, parent=None):
    ...
    def paintEvent(self, event):
        ...
        if self._hovered or self._pressed:
            ...
            painter.fillPath(path, QColor(255, 255, 255, 20 if self._hovered else 40))

        # 绘制图标
        painter.setFont(QFont("Segoe MDL2 Assets", 10))
...
class TitleBar(QWidget):
    ...
    def _init_ui(self):
        ...
        # 窗口控制按钮
        self.min_btn = TitleButton("\uE921")  # Minimize
        self.max_btn = TitleButton("\uE922")  # Maximize
        self.close_btn = TitleButton("\uE8BB")  # Close
    ...
    def _update_window_icon(self):
        """更新窗口图标"""
        pixmap = self.window.windowIcon().pixmap(20, 20)
